...
/***/ function(module, exports) {
	...
	var _user$project$Icon$viewIcon = function (name) {
		return A2(
	...
	var _user$project$Icon$labelStyles = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'verticalAlign', _1: 'middle'}
		]);
	var _user$project$Icon$iconStyles = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'verticalAlign', _1: 'middle'},
			{ctor: '_Tuple2', _0: 'margin-right', _1: '8px'}
		]);
	var _user$project$Icon$viewIconLabel = F2(
		function (name, label) {
			return A2(
				_elm_lang$html$Html$span,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$style(_user$project$Icon$iconStyles)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$style(_user$project$Icon$labelStyles)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
	...
	var _user$project$App$apiUrl = 'http://liferay.io/loopgame/players/';
	var _user$project$App$viewSortIcon = function (order) {
		var _p0 = order;
		if (_p0.ctor === 'Name') {
			return _user$project$Icon$viewIcon('perm_identity');
		} else {
			return _user$project$Icon$viewIcon('info');
		}
	};
	var _user$project$App$viewKey = A2(
		_elm_lang$html$Html$p,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_user$project$Icon$viewIconLabel, 'perm_identity', '= Name'),
				A2(_user$project$Icon$viewIconLabel, 'info', '= Score %')
			]));
	var _user$project$App$viewLoading = A2(
	...
	var _user$project$App$sortByName = F2(
		function (a, b) {
			return A2(_elm_lang$core$Basics$compare, a.name, b.name);
		});
	var _user$project$App$getWinP = function (entry) {
		var _p1 = entry.gamesPlayed;
		if (_p1 === 0) {
			return 0;
		} else {
			return _elm_lang$core$Basics$toFloat(entry.gamesWon) / _elm_lang$core$Basics$toFloat(entry.gamesPlayed);
		}
	};
	var _user$project$App$sortByScore = F2(
		function (a, b) {
			return A2(
				_elm_lang$core$Basics$compare,
				_user$project$App$getWinP(b),
				_user$project$App$getWinP(a));
		});
	var _user$project$App$viewScore = F2(
		function (i, entry) {
			return A2(
				_elm_lang$html$Html$tr,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_user$project$Icon$viewIconLabel, 'perm_identity', entry.name)
							])),
						A2(
						_elm_lang$html$Html$td,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								_user$project$Icon$viewIconLabel,
								'info',
								A2(
									_elm_lang$core$String$left,
									4,
									_elm_lang$core$Basics$toString(
										_user$project$App$getWinP(entry))))
							]))
					]));
		});
	var _user$project$App$viewScores = function (model) {
		var comparator = function () {
			var _p2 = model.sortOrder;
			if (_p2.ctor === 'Score') {
				return _user$project$App$sortByScore;
			} else {
				return _user$project$App$sortByName;
			}
		}();
		return A2(
			_elm_lang$core$List$indexedMap,
			_user$project$App$viewScore,
			A2(_elm_lang$core$List$sortWith, comparator, model.scores));
	};
	var _user$project$App$Entry = F5(
		function (a, b, c, d, e) {
			return {name: a, id: b, loopid: c, gamesPlayed: d, gamesWon: e};
		});
	var _user$project$App$decodeEntry = A6(
		_elm_lang$core$Json_Decode$object5,
		_user$project$App$Entry,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'loopId', _elm_lang$core$Json_Decode$int),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'gamesPlayed', _elm_lang$core$Json_Decode$int),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'gamesWon', _elm_lang$core$Json_Decode$int));
	var _user$project$App$decodeScores = _elm_lang$core$Json_Decode$list(_user$project$App$decodeEntry);
	var _user$project$App$Model = F3(
		function (a, b, c) {
			return {polling: a, scores: b, sortOrder: c};
		});
	var _user$project$App$Name = {ctor: 'Name'};
	var _user$project$App$Score = {ctor: 'Score'};
	var _user$project$App$Stopped = {ctor: 'Stopped'};
	var _user$project$App$Running = {ctor: 'Running'};
	var _user$project$App$Starting = {ctor: 'Starting'};
	var _user$project$App$RestartPolling = {ctor: 'RestartPolling'};
	var _user$project$App$viewError = A2(
		_elm_lang$html$Html$tr,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('There was an error contacting the server. '),
						A2(
						_elm_lang$html$Html$a,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href('javascript:void(0)'),
								_elm_lang$html$Html_Events$onClick(_user$project$App$RestartPolling)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
	...
	var _user$project$App$GetScoresFailure = function (a) {
		return {ctor: 'GetScoresFailure', _0: a};
	};
	var _user$project$App$GetScoresSuccess = function (a) {
		return {ctor: 'GetScoresSuccess', _0: a};
	};
	var _user$project$App$getScores = A3(
		_elm_lang$core$Task$perform,
		_user$project$App$GetScoresFailure,
		_user$project$App$GetScoresSuccess,
		A2(_evancz$elm_http$Http$get, _user$project$App$decodeScores, _user$project$App$apiUrl));
	var _user$project$App$init = {
		ctor: '_Tuple2',
		_0: A3(
			_user$project$App$Model,
			_user$project$App$Starting,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_user$project$App$Score),
		_1: _user$project$App$getScores
	};
			...
			switch (_p3.ctor) {
				...
				case 'GetScores':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{polling: _user$project$App$Running}),
						_elm_lang$core$Native_List.fromArray(
							[_user$project$App$getScores]));
				case 'GetScoresSuccess':
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
						...
						_elm_lang$core$Native_List.fromArray(
							[]));
				case 'GetScoresFailure':
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{polling: _user$project$App$Stopped}),
						_elm_lang$core$Native_List.fromArray(
							[]));
				default:
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{polling: _user$project$App$Starting}),
						_elm_lang$core$Native_List.fromArray(
							[]));
			}
		});
	var _user$project$App$GetScores = {ctor: 'GetScores'};
	var _user$project$App$subscriptions = function (model) {
		var _p4 = model.polling;
		if (_p4.ctor === 'Stopped') {
			return _elm_lang$core$Platform_Sub$none;
		} else {
			return A2(
				...
				function (t) {
					return _user$project$App$GetScores;
				});
		}
	};
	var _user$project$App$ChangeSort = function (a) {
		return {ctor: 'ChangeSort', _0: a};
	};
	var _user$project$App$viewSortDropdown = function (order) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('fixed-action-btn')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('btn-floating btn-large blue')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$App$viewSortIcon(order)
						])),
					A2(
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_user$project$App$ChangeSort(_user$project$App$Name)),
											_elm_lang$html$Html_Attributes$class('btn-floating')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											_user$project$App$viewSortIcon(_user$project$App$Name)
										]))
								])),
							A2(
							_elm_lang$html$Html$li,
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Events$onClick(
											_user$project$App$ChangeSort(_user$project$App$Score)),
											_elm_lang$html$Html_Attributes$class('btn-floating')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											_user$project$App$viewSortIcon(_user$project$App$Score)
										]))
								]))
						]))
				]));
	};
	var _user$project$App$viewNav = function (model) {
		return A2(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_user$project$App$viewSortDropdown(model.sortOrder),
									A2(
									_elm_lang$html$Html$span,
									_elm_lang$core$Native_List.fromArray(
										[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											A2(
												...
												'Players: ',
												_elm_lang$core$Basics$toString(
													_elm_lang$core$List$length(model.scores))))
										]))
								]))
						]))
				]));
	...
	var _user$project$App$view = function (model) {
		var tableContent = function () {
			var _p5 = model.polling;
			switch (_p5.ctor) {
				case 'Stopped':
					return _elm_lang$core$Native_List.fromArray(
						[_user$project$App$viewError]);
				case 'Starting':
					return _elm_lang$core$Native_List.fromArray(
						[_user$project$App$viewLoading]);
				default:
					return _user$project$App$viewScores(model);
			}
		}();
		return A2(
			_elm_lang$html$Html$div,
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_user$project$App$viewNav(model),
									A2(
									_elm_lang$html$Html$table,
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$class('centered striped z-depth-1')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											A2(
